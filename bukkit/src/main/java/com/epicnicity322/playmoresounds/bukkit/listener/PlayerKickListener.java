...
public final class PlayerKickListener extends MultiplePMSListener implements Listener {
    private final @NotNull SoundManager<Player, Entity> soundManager;

    public PlayerKickListener(@NotNull PlatformUtil platformUtil, @NotNull SoundManager<Player, Entity> soundManager) {
        super(platformUtil, "Player Kick", "Player Ban");
    ...
    public void onPlayerKick(PlayerKickEvent event) {
        ...
        PMSSoundList sound = player.isBanned() ? sounds[1] : sounds[0];
