...
public final class SwapHandsListener extends SinglePMSListener implements Listener {
    private final @NotNull SoundManager<Player, Entity> soundManager;

    public SwapHandsListener(@NotNull PlatformUtil platformUtil, @NotNull SoundManager<Player, Entity> soundManager) {
        super(platformUtil, "Swap Hands");
    ...
    public void onSwapHands(PlayerSwapHandItemsEvent event) {
        ...
        // If the items are equal the sound will not play.
        //noinspection ConstantValue - items may be null on older versions.
