...
public final class TeleportListener extends MultiplePMSListener implements Listener {
    private final @NotNull SoundManager<Player, Entity> soundManager;

    public TeleportListener(@NotNull PlatformUtil platformUtil, @NotNull SoundManager<Player, Entity> soundManager) {
        super(platformUtil, "Teleport", "World Change");
    ...
    public void onTeleport(PlayerTeleportEvent event) {
        ...
        PMSSoundList sound = event.getFrom().getWorld() == event.getTo().getWorld() ? sounds[0] : sounds[1];
