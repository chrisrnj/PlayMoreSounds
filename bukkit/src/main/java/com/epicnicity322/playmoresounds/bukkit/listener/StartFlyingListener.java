...
public final class StartFlyingListener extends MultiplePMSListener implements Listener {
    private final @NotNull SoundManager<Player, Entity> soundManager;

    public StartFlyingListener(@NotNull PlatformUtil platformUtil, @NotNull SoundManager<Player, Entity> soundManager) {
        super(platformUtil, "Start Flying", "Stop Flying");
    ...
    public void onStartFlying(PlayerToggleFlightEvent event) {
        ...
        PMSSoundList sound = event.isFlying() ? sounds[0] : sounds[1];
