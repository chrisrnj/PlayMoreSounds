...
public final class PlayMoreSounds {
    @NotNull
    public static final Path DATA_FOLDER = EpicPluginLib.Platform.getPlatform() == EpicPluginLib.Platform.BUKKIT ? Path.of("plugins", "PlayMoreSounds") : Path.of("config", "PlayMoreSounds");
    @NotNull
