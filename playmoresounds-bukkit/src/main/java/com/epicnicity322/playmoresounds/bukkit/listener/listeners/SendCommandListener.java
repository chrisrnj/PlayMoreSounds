...
public final class SendCommandListener extends SinglePMSListener {
    public SendCommandListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Send Command");
    }
