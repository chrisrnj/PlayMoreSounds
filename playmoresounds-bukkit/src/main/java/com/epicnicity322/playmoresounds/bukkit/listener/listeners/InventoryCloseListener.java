...
public final class InventoryCloseListener extends SinglePMSListener {
    public InventoryCloseListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Inventory Close");
    }

    @EventHandler
    public void onInventoryClose(InventoryCloseEvent event) {
        PlayMoreSoundsPlugin.soundManager().play(sound, (Player) event.getPlayer());
    }
}
