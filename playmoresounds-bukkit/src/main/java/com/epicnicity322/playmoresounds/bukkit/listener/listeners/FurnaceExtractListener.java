...
public final class FurnaceExtractListener extends SinglePMSListener {
    public FurnaceExtractListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Furnace Extract");
    }
