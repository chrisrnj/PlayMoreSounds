...
public final class ChangeLevelListener extends SinglePMSListener {
    public ChangeLevelListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Change Level");
    }
