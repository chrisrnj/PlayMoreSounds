...
public final class GameModeChangeListener extends SinglePMSListener {
    public GameModeChangeListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Game Mode Change");
    }
