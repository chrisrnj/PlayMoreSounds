...
public final class InventoryClickListener extends SinglePMSListener {
    public InventoryClickListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Inventory Click");
    }
