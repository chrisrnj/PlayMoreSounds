...
public final class LeaveServerListener extends SinglePMSListener {
    public LeaveServerListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Leave Server");
    }
