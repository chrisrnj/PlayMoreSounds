...
public final class ToggleSneakListener extends SinglePMSListener {
    public ToggleSneakListener(@NotNull PlayMoreSoundsPlugin plugin) {
        super(plugin, "Toggle Sneak");
    }
