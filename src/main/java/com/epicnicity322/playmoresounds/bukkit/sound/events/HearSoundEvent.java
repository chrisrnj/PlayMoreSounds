 ...
 * then this event is called for every person online in the server, because all of them hears the sound.
 */
public class HearSoundEvent extends Event implements Cancellable
{
    ...
    public HearSoundEvent(@NotNull PlayableSound sound, @NotNull Player player, @NotNull Location location,
